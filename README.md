...
¹ *AN Holdings CO., Nishinomiya, Japan* | ² *Kobe Gakuin University, Kobe, Japan* | [cite_start]³ *Kobe Design Lab, Kobe, Japan* [cite: 354, 355, 356, 357]
...
| **2 — Telemetry** | Real-time tracking of the Mission Kill Index (MKI); failure at $\Gamma(t) > \Gamma_{crit}=6.5$. |
| **3 — CEP** | Expansion of Circular Error Probable relative to operational tolerance $R_L$. |
| **4 — Information Theory** | Systematic growth of Shannon Entropy $h(X)$, representing uncertainty growth. |
...
[cite_start]Advanced multi-sensor fusion architectures improve nominal precision while simultaneously expanding the estimator's vulnerability surface[cite: 384].

<div align="center">
  <img src="Figures/Figure_1.png" width="800" alt="EKF Loop">
...
[cite_start]Reproduces all empirical results in Section II-E of the manuscript[cite: 457].
...
### [cite_start]**Verified Results (v2.1 Anchor)** [cite: 365, 366, 465, 468, 469, 470]
...
<div align="center">
  <img src="Figures/Figure_2.png" width="850" alt="Temporal Evolution">
  [cite_start]<br><em>Fig 2. Temporal evolution of the Estimator Instability Number $\Gamma(t)$[cite: 437]. [cite_start]Panel D confirms the SMK condition while internal covariance remains bounded[cite: 439].</em>
</div>

<div align="center">
  <img src="Figures/Figure_3.png" width="850" alt="Gamma Exceedance">
  [cite_start]<br><em>Fig 3. 100% any-time exceedance of $\Gamma_{crit} = 6.5$ across $N=500$ runs[cite: 559].</em>
</div>
...
<div align="center">
  <img src="Figures/Figure_5.png" width="850" alt="NIS Compliance">
...
[cite_start]ECT introduces four primary metrics to quantify failure[cite: 387]:
* [cite_start]**$\Gamma(t)$**: Ratio of actual MSE to nominal MSE[cite: 429].
* [cite_start]**MKI**: Ratio of expanded CEP to operational failure threshold $R_L$[cite: 441].
* [cite_start]**$\eta_{info}$**: Efficiency of uncertainty generation via Shannon entropy[cite: 449].
* **$R_{IE}$**: Cost-benefit metric reserved for Phase II HWIL testing[cite: 629].
...
* `Graphical_Abstract.png`: Root directory abstract.
